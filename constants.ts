...
export const MOCK_PROJECT_IDEAS: ProjectIdea[] = [
  ...
  { id: 'idea-14', title: 'Cattle dip for Kabondo', description: 'From SMS: "Our cows are getting sick from ticks. Pls build a new cattle dip for farmers in Kabondo Kasipul."', location: 'Kabondo', submittedVia: 'sms', category: 'AGRICULTURE', subCounty: 'Kabondo Kasipul', ward: 'Kabondo East', votes: 22, comments: [] },
