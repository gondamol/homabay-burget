...
export const MOCK_PROJECT_IDEAS: ProjectIdea[] = [
  { id: 'idea-1', title: 'New borehole for Mbita market', description: 'The market needs a reliable source of clean water to improve sanitation.', location: 'Mbita', submittedVia: 'web', subCounty: 'Suba North', ward: 'Kasgunga', votes: 25, comments: [], status: 'Pending' },
  { id: 'idea-2', title: 'Fix the road to Kasgunga beach', description: 'The road is full of potholes, making it difficult for fishermen and tourists.', location: 'Kasgunga', submittedVia: 'sms', category: 'ROADS', subCounty: 'Suba North', ward: 'Kasgunga', votes: 42, comments: [], status: 'Pending' },
  { id: 'idea-3', title: 'Upgrade maternity wing at Suba hospital', description: 'The current maternity wing is too small and lacks modern equipment.', location: 'Sindo Town', submittedVia: 'web', subCounty: 'Suba South', ward: 'Gwassi South', votes: 58, comments: [], status: 'Pending' },
  { id: 'idea-13', title: 'Need weekly garbage pickup in Rangwe', description: 'Recorded via phone: "The trash in Rangwe town is a big problem. We need the county to organize a lorry to collect it every week. It is becoming a health hazard for our children."', location: 'Rangwe', submittedVia: 'voice', category: 'SERVICES', subCounty: 'Rangwe', ward: 'West Gem', votes: 15, comments: [], status: 'Pending' },
  { id: 'idea-4', title: 'More street lights in Homa Bay town', description: 'Improved lighting will enhance security at night.', location: 'Homa Bay Town', submittedVia: 'web', subCounty: 'Homa Bay Town', ward: 'Homa Bay Central', votes: 31, comments: [], status: 'Pending' },
  { id: 'idea-5', title: 'Waste collection services for Kendu Bay', description: 'Garbage is piling up, we need a regular collection system.', location: 'Kendu Bay', submittedVia: 'sms', category: 'SERVICES', subCounty: 'Karachuonyo', ward: 'Kendu Bay Town', votes: 19, comments: [], status: 'Pending' },
  { id: 'idea-14', title: 'Cattle dip for Kabondo', description: 'From SMS: "Our cows are getting sick from ticks. Pls build a new cattle dip for farmers in Kabondo Kasipul."', location: 'Kabondo', submittedVia: 'sms', category: 'AGRICULTURE', subCounty: 'Kabondo Kasipul', ward: 'Kabondo East', votes: 22, comments: [], status: 'Pending' },
  { id: 'idea-6', title: 'Another water point needed in Remba island', description: 'The single borehole is not enough for the whole community.', location: 'Remba Island', submittedVia: 'sms', category: 'WATER', subCounty: 'Suba North', ward: 'Gembe', votes: 65, comments: [], status: 'Pending' },
  { id: 'idea-7', title: 'Repair bridge on Rusinga ring road', description: 'The bridge is becoming unsafe for vehicles.', location: 'Rusinga Island', submittedVia: 'web', subCounty: 'Suba North', ward: 'Rusinga Island', votes: 38, comments: [], status: 'Pending' },
  { id: 'idea-8', title: 'Equip youth polytechnic with computers', description: 'Our youth need digital skills to find jobs.', location: 'Ndhiwa', submittedVia: 'web', subCounty: 'Ndhiwa', ward: 'Kanyadoto', votes: 45, comments: [], status: 'Pending' },
  { id: 'idea-9', title: 'Ambulance for Nyandiwa health center', description: 'Emergencies are hard to handle without a dedicated ambulance.', location: 'Nyandiwa', submittedVia: 'web', subCounty: 'Suba South', ward: 'Gwassi North', votes: 72, comments: [], status: 'Pending' },
  { id: 'idea-10', title: 'Provide fertilizer subsidies to farmers in Karachuonyo', description: 'High fertilizer costs are reducing farm yields.', location: 'Karachuonyo', submittedVia: 'web', subCounty: 'Karachuonyo', ward: 'North Karachuonyo', votes: 29, comments: [], status: 'Pending' },
  { id: 'idea-11', title: 'Rehabilitate fish landing site at Sindo', description: 'The current site is dilapidated and unhygienic.', location: 'Sindo', submittedVia: 'sms', category: 'INFRASTRUCTURE', subCounty: 'Suba South', ward: 'Gwassi South', votes: 51, comments: [], status: 'Pending' },
  { id: 'idea-12', title: 'Drill a well at the community school', description: 'School children lack access to safe drinking water.', location: 'Mbita', submittedVia: 'web', subCounty: 'Suba North', ward: 'Kasgunga', votes: 60, comments: [], status: 'Pending' },
];
...
export const MOCK_OFFICIAL_PROJECTS: OfficialProject[] = [
  ...
  },
  {
    ...
    category: 'EDUCATION',
    // FIX: Added missing 'forum' property to satisfy the OfficialProject type.
    forum: [],
  },
];
