...
export const LightBulbIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18v-5.25m0 0a6.01 6.01 0 001.5-.189m-1.5.189a6.01 6.01 0 01-1.5-.189m3.75 7.478a12.06 12.06 0 01-4.5 0m3.75 2.311a11.999 11.999 0 01-1.004 2.153m-.003-2.153a11.999 11.999 0 00-1.004-2.153m2.007 2.153a12.001 12.001 0 01-2.007 0M12 6.375a3.375 3.375 0 013.375 3.375h-6.75A3.375 3.375 0 0112 6.375z" /></svg>
);
...
export const FaceSmileIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M15.182 15.182a4.5 4.5 0 01-6.364 0M21 12a9 9 0 11-18 0 9 9 0 0118 0zM9 9.75h.008v.008H9V9.75zm6 0h.008v.008H15V9.75z" /></svg>
);
...
export const UserGroupIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.741-.479 3 3 0 00-4.682-2.72m-7.5-2.962c.51.056 1.02.082 1.5.082a9.093 9.093 0 013.185-.797m-6.37-2.43a9.093 9.093 0 016.37-2.43m-8.37 14.28c-2.492-2.134-3.427-5.462-2.9-8.429m14.28 11.33c.228-.56.32-1.14.32-1.732m-14.96 0c0-.592.092-1.172.268-1.732M12 12c-2.485 0-4.5-2.015-4.5-4.5s2.015-4.5 4.5-4.5 4.5 2.015 4.5 4.5-2.015 4.5-4.5 4.5zm0 0v-4.5" /></svg>
);
...
export const GavelIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M12 18.75a6 6 0 006-6h-4.5a.75.75 0 01-.75-.75V8.25a.75.75 0 01.75-.75h4.5a6 6 0 10-6 6.75V18.75z" /><path strokeLinecap="round" strokeLinejoin="round" d="M13.5 12h-4.5" /></svg>
);
...
export const StalledIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
...
export const ChatBubbleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.5 1.5 0 01-2.12 0l-3.72-3.72C6.347 17.657 5.5 16.693 5.5 15.557V11.272c0-.97 0.616-1.813 1.5-2.097m11.25 0c1.332-0.284 2.25-1.531 2.25-2.915V5.557c0-1.136-.847-2.1-1.98-2.193l-3.72 3.72a1.5 1.5 0 01-2.12 0l-3.72-3.72C6.347 2.343 5.5 3.307 5.5 4.443V6.66c0 1.384 0.918 2.631 2.25 2.915m11.25 0c-3.832-0.752-7.667-0.752-11.5 0" /></svg>
);
...
export const CalculatorIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M9 17.25v.75M9 21v-3.75m0 0h3.75M9 17.25a3.75 3.75 0 01-3.75-3.75V4.5a3.75 3.75 0 013.75-3.75h5.25a3.75 3.75 0 013.75 3.75v9a3.75 3.75 0 01-3.75 3.75H9zm0-12.75h3.75M9 10.5h3.75M9 13.5h3.75m-3.75 0a.75.75 0 00-.75.75v3a.75.75 0 00.75.75h3.75a.75.75 0 00.75-.75v-3a.75.75 0 00-.75-.75M9 13.5H5.25m0 0v.75m0-1.5V12m0 0H3.75m0 0h1.5m3 0h3.75m-3.75 0a.75.75 0 01-.75.75v3a.75.75 0 01.75.75h3.75a.75.75 0 01.75-.75v-3a.75.75 0 01-.75-.75M9 13.5H5.25" /></svg>
);
...
export const DocumentChartBarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.5h-8.01a1.5 1.5 0 01-1.5-1.5V5.25a1.5 1.5 0 011.5-1.5h6.105a2.25 2.25 0 012.25 2.25v2.25a2.25 2.25 0 002.25 2.25H19.5a2.25 2.25 0 012.25 2.25v.03a2.25 2.25 0 01-2.25 2.25h-4.01a1.5 1.5 0 01-1.5-1.5v-2.25a1.5 1.5 0 00-1.5-1.5h-1.5m0 3.75a3 3 0 116 0 3 3 0 01-6 0z" /></svg>
);

export const ThumbsUpIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}><path strokeLinecap="round" strokeLinejoin="round" d="M6.633 10.5c.806 0 1.533-.424 2.031-1.08a9.041 9.041 0 012.861-2.4c.723-.384 1.35-.956 1.653-1.715a4.498 4.498 0 00.322-1.672V3a.75.75 0 01.75-.75A2.25 2.25 0 0116.5 4.5c0 1.152-.26 2.243-.723 3.218-.266.558.107 1.282.725 1.282h3.126c1.026 0 1.945.694 2.054 1.715.045.422.068.85.068 1.285a11.95 11.95 0 01-2.649 7.521c-.388.482-.987.729-1.605.729H13.48c-.483 0-.964-.078-1.423-.23l-3.114-1.04a4.501 4.501 0 00-1.423-.23H5.904M6.633 10.5l-1.14-1.14a.75.75 0 00-1.061 0l-1.14 1.14a.75.75 0 000 1.061l1.14 1.14a.75.75 0 001.061 0l1.14-1.14a.75.75 0 000-1.061z" /></svg>
);
